...
public class EmployeeStaff implements Serializable {
	...
	public String toString() {
		return "EmployeeStaff [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", birthdate="
				+ birthdate + ", address=" + address + ", telephone=" + telephone + ", email=" + email + ", userName="
				+ userName + ", password=" + password + ", verifyOrders=" + verifyOrders + ", verifiedOrders="
				+ verifiedOrders + ", cashiers=" + cashiers + ", salesReportEmp=" + salesReportEmp + "]";
	}

	@Override
	public int hashCode() {
		return Objects.hash(address, birthdate, cashiers, email, firstName, id, lastName, password, salesReportEmp,
				telephone, userName, verifiedOrders, verifyOrders);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmployeeStaff other = (EmployeeStaff) obj;
		return Objects.equals(address, other.address) && Objects.equals(birthdate, other.birthdate)
				&& Objects.equals(cashiers, other.cashiers) && Objects.equals(email, other.email)
				&& Objects.equals(firstName, other.firstName) && Objects.equals(id, other.id)
				&& Objects.equals(lastName, other.lastName) && Objects.equals(password, other.password)
				&& Objects.equals(salesReportEmp, other.salesReportEmp) && Objects.equals(telephone, other.telephone)
				&& Objects.equals(userName, other.userName) && Objects.equals(verifiedOrders, other.verifiedOrders)
