...
@Component
public class CustomerEntityDTOMapperImpl implements CustomerEntityDTOMapper {
	...
	protected OrderProductDTO orderProductToOrderProductDTO(OrderProduct orderProduct) {
		...
		orderProductDTO.setCustomer(customerToDTO(orderProduct.getCustomer()));
	...
	protected InvoiceReceiptDTO invoiceReceiptToInvoiceReceiptDTO(InvoiceReceipt invoiceReceipt) {
		...
		invoiceReceiptDTO.setCustomer(customerToDTO(invoiceReceipt.getCustomer()));
	...
	protected Set<InvoiceReceiptDTO> invoiceReceiptSetToInvoiceReceiptDTOSet(Set<InvoiceReceipt> set) {
		...
		for (InvoiceReceipt invoiceReceipt : set) {
			set1.add(invoiceReceiptToInvoiceReceiptDTO(invoiceReceipt));
		}
	...
	protected CashierDTO cashierToCashierDTO(Cashier cashier) {
		...
		/*
		 * if ( cashierDTO.getInvoiceReceipts() != null ) { Set<InvoiceReceiptDTO> set =
		 * invoiceReceiptSetToInvoiceReceiptDTOSet( cashier.getInvoiceReceipts() ); if (
		 * set != null ) { cashierDTO.getInvoiceReceipts().addAll( set ); } }
		 */
		return cashierDTO;
	}
	...
	protected OrderProduct orderProductDTOToOrderProduct(OrderProductDTO orderProductDTO) {
		...
		orderProduct.setCustomer(customerDTOToEntity(orderProductDTO.getCustomer()));
	...
	protected InvoiceReceipt invoiceReceiptDTOToInvoiceReceipt(InvoiceReceiptDTO invoiceReceiptDTO) {
		...
		invoiceReceipt.setCustomer(customerDTOToEntity(invoiceReceiptDTO.getCustomer()));
	...
	protected Set<InvoiceReceipt> invoiceReceiptDTOSetToInvoiceReceiptSet(Set<InvoiceReceiptDTO> set) {
		...
		for (InvoiceReceiptDTO invoiceReceiptDTO : set) {
			set1.add(invoiceReceiptDTOToInvoiceReceipt(invoiceReceiptDTO));
		}
